...
- Главная страница:
  1. Наличие секции по вводу промокода;
  2. Проверка наименования почты в разделе акций;
  3. Наличие секции "Новые фильмы" в разделе "Магазин";
  4. Проверка урла после редиректа по кнопке "Подписка";
- Карточка фильма:
  1. Наличие кнопки "Купить";
  2. Отображение плеера при просмотре трейлера;
  3. Оценка фильма незарегистрированным пользователем;
- Поиск фильмов:
  1. Отображение на странице поиска секции "Часто ищут";
  2. Поиск фильма по наименованию;
  3. Поиск фильма по фамилии и имени режиссера;
